...
public class UserServiceImpl implements UserService {
	...
	@Override
	public UserDto findUser(String name, String emailId, String emailDomain) throws SQLException {
		return userMapper.findUser(name, emailId, emailDomain);
	}

	@Override
	public MailDto createMailAndChangePassword(String id, String name, String emailId, String emailDomain) throws SQLException {
