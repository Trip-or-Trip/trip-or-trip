...
<%@ include file="/include/nav.jsp" %>
        ...
        <div class="signup">
        	<form id="signup-form" method="POST" role="search">
	            ...
	            <div class="row d-flex justify-content-center my-4">
	            	<div class="col-10">
	                	<input type="text" class="form-control" name="signup-id" id="signup-id" placeholder="아이디">
					</div>
	            </div>
	            <div class="row d-flex justify-content-center my-4">
	            	<div class="col-10">
	            ...
	            <div class="row d-flex justify-content-center login_pw my-4">
	            	<div class="col-10">
	                	<input type="password" class="form-control" name="signup-password" id="signup-password" placeholder="비밀번호">
	            	</div>
	            </div>
	            <div class="row d-flex justify-content-center login_pw my-4">
	            	<div class="col-10">
	            ...
	            <div class="row d-flex justify-content-center my-4">
	            	<div class="col-10">
	                	<input type="text" class="form-control" name="signup-name" id="signup-name" placeholder="이름">
					</div>
	            </div>
	            <div class="row d-flex justify-content-center my-4">
	            	<div class="col-10">
	                	<input type="email" class="form-control" name="signup-email" id="signup-email" placeholder="이메일">
					</div>
	            </div>
	...
	<script>
		...
		document.getElementById("signup-id").addEventListener("keyup", function() {
			fetch("${root}/user?action=idcheck&userid=" + this.value)
